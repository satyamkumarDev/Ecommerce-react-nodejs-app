...
export default function RegisterScreen(props){
    ...
    const submitHandler=(e)=>{
        ...
        if(password !== cpassword){
            alert('Passwrd and Confirm Password are not match')
        }
        ...
        <div>
            <form className="form" onSubmit={submitHandler}>
                ...
                <div>
                    ...
                    <input type="password" id="cpassword" placeholder="Enter confirm Password" required onChange={e=>setConfirmpassword(e.target.value)}></input>
                </div>
                <div>
                    <label />
